...
<section class="glav">
    <div class="container">
        <div class="containerGlavInfo">
            <div class="glavTitle txSt">Контакты</div>
            <div class="glavInfoRow">
                <div class="glavInfoCol">О нас</div>
                <div class="glavInfoCol">Документы</div>
                <div class="glavInfoCol">Коллектив</div>
                <div class="glavInfoCol">История</div>
                <div class="glavInfoCol">Гимн и флаг</div>
                <div class="glavInfoCol">Партнёры</div>
                <div class="glavInfoCol">Основные сведения</div>
                <div class="glavInfoCol">Дополнительно...</div>
            </div>
